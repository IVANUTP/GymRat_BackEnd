...
public class RutinaController {
    ...
    @PostMapping
    public ResponseEntity<RutinaResponseDTO> guardar(
            @RequestBody RutinaRequestDTO dto
    ){
        return ResponseEntity
                .status(HttpStatus.CREATED)
                .body(rutinaService.guardar(dto));
    ...
    @GetMapping("/{id}")
    public ResponseEntity<RutinaResponseDTO> buscar(
            @PathVariable Long id
    ){
        return ResponseEntity.ok(
                rutinaService.buscar(id)
        );
    ...
    public ResponseEntity<RutinaResponseDTO> actualizar(
        ...
        return ResponseEntity.ok(
                rutinaService.actualizar(id, dto)
        );
